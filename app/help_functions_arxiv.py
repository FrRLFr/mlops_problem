...
#https://export.arxiv.org/api/query?search_query=au:fritsch&skip=0&max_results=8&sortBy=relevance&sortOrder=descending
#http://export.arxiv.org/api/query?search_query=au:fritsch&skip=0&max_results=8&sortBy=relevance&sortOrder=descending
